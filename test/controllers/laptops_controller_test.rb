...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post laptops_url, params: { laptop: { model: @laptop.model, processor: @laptop.processor, ram: @laptop.ram } }
    end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { model: @laptop.model, processor: @laptop.processor, ram: @laptop.ram } }
