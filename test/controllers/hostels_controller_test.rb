...
class HostelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post hostels_url, params: { hostel: { product_description: @hostel.product_description, product_id: @hostel.product_id, product_name: @hostel.product_name } }
    end
  ...
  test "should update hostel" do
    patch hostel_url(@hostel), params: { hostel: { product_description: @hostel.product_description, product_id: @hostel.product_id, product_name: @hostel.product_name } }
