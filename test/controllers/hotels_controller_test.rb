...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { address: @hotel.address, city: @hotel.city, name: @hotel.name } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { address: @hotel.address, city: @hotel.city, name: @hotel.name } }
