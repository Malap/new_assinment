...
class HostelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post hostels_url, params: { hostel: { address: @hostel.address, name: @hostel.name, room: @hostel.room } }
    end
  ...
  test "should update hostel" do
    patch hostel_url(@hostel), params: { hostel: { address: @hostel.address, name: @hostel.name, room: @hostel.room } }
